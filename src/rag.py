...
class VectorRetriever:
    ...
    def retrieve(
        ...
        sql = f"""
        SELECT id, content, accusations, articles, punishment, source_case_id, source_chunk_index,
        ...
        return [
            Document(
                ...
                metadata={
                    ...
                    "source_case_id": doc.get("source_case_id") or doc.get("id", ""),
                    "source_chunk_index": doc.get("source_chunk_index", 0),
                },
            )
            for doc in reranked
        ]
